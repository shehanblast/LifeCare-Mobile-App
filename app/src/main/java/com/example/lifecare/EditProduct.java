...
public class EditProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productQty = findViewById(R.id.product_qty_details);
        eQty = findViewById(R.id.editQty);
        change = findViewById(R.id.change);
//        eQty2 = findViewById(R.id.editQty2);
        addImage = findViewById(R.id.product_image_details);
                                            ...
                                            itemRef.child(productID).updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if(task.isSuccessful()){
                                                        Toast.makeText(EditProduct.this, "Added to Cart!.", Toast.LENGTH_SHORT).show();
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    Picasso.get().load(product.getImage()).into(addImage);
